...
public class Sphere extends RenderObject{
    ...
    public Sphere(float radius, Vector center) {
        this(radius, center, new Vector(1, 1, 1), new Vector(0, 0, 0), new Vector(0,0,0), new Vector(0,0,0));
    }

    public Sphere(float radius, Vector center, Vector ambientCo, Vector diffuseCo, Vector specularCo, Vector reflectCo) {
